...
type ProductsConnection = {
  ...
  readonly group: ReadonlyArray<ProductsGroupConnection>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly nodes: ReadonlyArray<Products>;
  readonly pageInfo: PageInfo;
  readonly sum: Maybe<Scalars['Float']>;
  readonly totalCount: Scalars['Int'];
};
...
type ProductsConnection_distinctArgs = {
  field: ProductsFieldsEnum;
};


type ProductsConnection_groupArgs = {
  field: ProductsFieldsEnum;
  limit: InputMaybe<Scalars['Int']>;
  skip: InputMaybe<Scalars['Int']>;
};
...
type ProductsConnection_maxArgs = {
  field: ProductsFieldsEnum;
};


type ProductsConnection_minArgs = {
  field: ProductsFieldsEnum;
};


type ProductsConnection_sumArgs = {
  field: ProductsFieldsEnum;
};

type ProductsEdge = {
  readonly next: Maybe<Products>;
  readonly node: Products;
  readonly previous: Maybe<Products>;
};

type ProductsFieldsEnum =
  | 'Category'
  | 'DescriptionURI'
  | 'ImageURI'
  | 'Images'
...
type ProductsFilterInput = {
  readonly Category: InputMaybe<IntQueryOperatorInput>;
  readonly DescriptionURI: InputMaybe<StringQueryOperatorInput>;
...
type ProductsGroupConnection_distinctArgs = {
  field: ProductsFieldsEnum;
};


type ProductsGroupConnection_groupArgs = {
  field: ProductsFieldsEnum;
  limit: InputMaybe<Scalars['Int']>;
  skip: InputMaybe<Scalars['Int']>;
};
...
type ProductsGroupConnection_maxArgs = {
  field: ProductsFieldsEnum;
};


type ProductsGroupConnection_minArgs = {
  field: ProductsFieldsEnum;
};


type ProductsGroupConnection_sumArgs = {
  field: ProductsFieldsEnum;
};

type ProductsImages = {
  readonly alt: Maybe<Scalars['String']>;
  readonly image_uri: Maybe<Scalars['String']>;
};

type ProductsImagesFilterInput = {
  readonly alt: InputMaybe<StringQueryOperatorInput>;
  readonly image_uri: InputMaybe<StringQueryOperatorInput>;
};

type ProductsImagesFilterListInput = {
  readonly elemMatch: InputMaybe<ProductsImagesFilterInput>;
};

type ProductsSortInput = {
  readonly fields: InputMaybe<ReadonlyArray<InputMaybe<ProductsFieldsEnum>>>;
  readonly order: InputMaybe<ReadonlyArray<InputMaybe<SortOrderEnum>>>;
};
...
type Query = {
  ...
  readonly allProducts: ProductsConnection;
  ...
  readonly products: Maybe<Products>;
...
type Query_productsArgs = {
  ...
  DescriptionURI: InputMaybe<StringQueryOperatorInput>;
...
type ConfirmPageQuery = { readonly site: { readonly siteMetadata: { readonly title: string, readonly description: string } } | null };
